...
$U_{n}$ and $U_{p}$ are net generation recombination rates. These terms were not used for the modeling of the memristor. (Not sure how to justify this. Maybe I can say I have not used it because there is no equation for it and it is not modeled yet ? I dont even know if GR happens in PEDOT )
