...
As AC potential pushes lithium ions from one side to the other, an equilibrium is reached over time. At first, there is a drop in the average current since lithium diffusion is greater than lithium drift. This transient effect disappears once enough lithium settles into the PEDOT:PSS. 
