...
\begin{figure}[!htp]
\centering
\includegraphics[scale=0.60]{Ex5V}
...
\begin{figure}[!htp]
\centering
\includegraphics[scale=0.60]{Ex5E}
...
\begin{figure}[!htp]
\centering
\includegraphics[scale=0.60]{Ex5V_notch}
\caption{Potential at steady state} 
\label{MemVss_notch}
\end{figure}
...
\begin{figure}[!htp]
\centering
\includegraphics[scale=0.60]{Ex5E_notch}
\caption{Electric field at steady state} 
\label{MemEss_notch}
\end{figure}
...
\begin{figure}[!htp]
\centering
\includegraphics[scale=0.40]{Ex4V}
\caption{Potential at steady state} 
\label{}
\end{figure}
